...
let {max: max$2, pow: pow$1, sqrt: sqrt$1, PI: PI$1} = Math;
...
let hslToHsv = (h, s, l) => {
  ...
  hh = 360 * hh;
  ss = max$1(0, min(1, ss)) * 100;
  vv = max$1(0, min(1, vv)) * 100;
